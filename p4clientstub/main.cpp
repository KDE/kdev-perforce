...
int fakeAnnotateOutput()
{
    ...
    std::cout << "1: " << std::endl;
    std::cout << "1: " << std::endl;
    std::cout << "3: void fillBuffer( RingBuffer& myBuffer, std::vector<uint64_t>& testVector )" << std::endl;
    std::cout << "1: {" << std::endl;
    std::cout << "1:     uint64_t random_range( std::numeric_limits<unsigned long>::max() );" << std::endl;
    std::cout << "7:     uint64_t random_number ( 0 );" << std::endl;
    std::cout << "12:     /// First fill the buffer" << std::endl;
    std::cout << "1:     for ( size_t i =0; i < RINGBUFFER_SIZE; ++i )" << std::endl;
    std::cout << "1:     {" << std::endl;
    std::cout << "3:         random_number = std::rand() % random_range;" << std::endl;
    std::cout << "3:         myBuffer.push_back ( random_number );" << std::endl;
    std::cout << "3:         testVector.push_back ( random_number );" << std::endl;
    std::cout << "2:     }" << std::endl;
    std::cout << "10: }" << std::endl;
    std::cout << "10: " << std::endl;
    std::cout << "9: void testWithOnlyknown( RingBuffer& myBuffer, std::vector<uint64_t>& testVector )" << std::endl;
    std::cout << "9: {" << std::endl;
    std::cout << "9:     uint64_t random_range ( RINGBUFFER_SIZE );" << std::endl;
    std::cout << "8:     uint64_t random_number ( 0 );" << std::endl;
    std::cout << "7:     /// Perform the test run on values we have already inserted." << std::endl;
    ...
    std::cout << "13: }" << std::endl;
    std::cout << "13: " << std::endl;
    std::cout << "6: int main( int argc, char **argv )" << std::endl;
    std::cout << "6: {" << std::endl;
    std::cout << "4:     RingBuffer myBuffer;" << std::endl;
    ...
    std::cout << "5:     testWithOnlyknown( myBuffer, testVector );" << std::endl;
    std::cout << "5: 	" << std::endl;
    std::cout << "5:     std::cout << \\\"Done Testing\\\" << std::endl;" << std::endl;
    std::cout << "1: " << std::endl;
